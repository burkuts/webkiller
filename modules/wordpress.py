...
""").split("\n")
    print(Fore.GREEN+" [+] Lütfen WordPress URL'sini Girin\n")
    print(Fore.RED+" [!] PLütfen Http'yi Dahil Etmeyin\n")
    try:
 ...
 └──╼ 卐 """).lower()
        if url == "" or None:
            ...
            time.sleep(1)
            print(Fore.RED+"Lütfen URL'yi Girin")
            time.sleep(0.3)
            sys.exit()
        s = requests.get("http://"+url+"/wp-content/plugins/")
        if s.status_code == 404 or s.status_code == 500:
            print(Fore.RED+" [!] "+Fore.YELLOW+"SSite Wordpress DEĞİL")
            sys.exit()
        else:
            pass
        time.sleep(0.5)
        print(Fore.YELLOW+" [!] 1000 En İyi eklenti taranıyor ...\n")
        time.sleep(4)
        print(Fore.BLUE+" [!] 1000 Eklenti Yükleniyor...\n")
        time.sleep(3)
        print(Fore.CYAN+" [*] "+Fore.GREEN+" Lütfen Bekleyin\n")
    except:
        print("")
        sys.exit()
    for plus in pl:
        ...
        try:
            ...
            print("")
            sys.exit()
    input(Fore.GREEN+"\n [*] Menüye Dön (Enter Tuşuna Bas...) ")

def user():
    try:
        print(Fore.GREEN+" [+] Lütfen WordPress URL'sini Girin\n")
        print(Fore.RED+" [!] Lütfen Http'yi Dahil Etmeyin\n")
 ...
 └──╼ """+Fore.WHITE+"卐 ").lower()
        ...
        s = requests.get("http://"+Url+"/wp-content/plugins/")
        if s.status_code == 404 or s.status_code == 500:
            print(Fore.RED+" [!] "+Fore.YELLOW+"Site Wordpress DEĞİL")
            sys.exit()
        else:
            pass
        print(Fore.GREEN+" [-] "+"Lütfen Bekleyin . . .\n")
        time.sleep(0.5)
    except:
        print("")
        sys.exit()
    try:
        ...
        for Val in j:
            ...
            cn += 1
        if User == '':
            User = Fore.RED+'Bulunamadı!'

        print (User+"\n")
        # else:
        #     print("User Not Found")
    except:
        print(Fore.BLUE+" [!] "+Fore.RED+"HATA ! ! \n"+"\n"+Fore.BLUE+" [!] "+Fore.GREEN+"Lütfen Geçerli Adresi Girin\n"+"\n"+Fore.BLUE+" [!] "+Fore.LIGHTWHITE_EX+"Veya Lütfen Bağlantınızı Kontrol Edin\n"+"\n"+Fore.BLUE+" [!] "+Fore.YELLOW+"Ya da kullanıcı adını bulamadım\n ")
        sys.exit()
    try:
