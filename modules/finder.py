...
def __start__():
    try:
        print(Fore.RED+" [!] Web Site Adresini Girin\n")
        url = input(Fore.RED+" ┌─["+Fore.LIGHTGREEN_EX+"WEBKILLER"+Fore.BLUE+"~"+Fore.WHITE+"@HOME"+Fore.RED+"/"+Fore.CYAN+"IG"+Fore.RED+"/"+Fore.LIGHTYELLOW_EX+"Admin-Panel-Bulucu"+Fore.RED+"""]
 └──╼ """+Fore.WHITE+"卐 ")
...
'adm/index.brf','adm.brf','affiliate.brf','adm_auth.brf','memberadmin.brf','administratorlogin.brf','cpanel','cpanel.php','cpanel.html',]
        ...
        for i in list_:
            ...
            if r.status_code == 200:
                print(Fore.GREEN+"[+] "+url+i+" Bulundu")
            else:
                print(Fore.RED+"[-] "+url+i+" Bulunamadı")
        try:
